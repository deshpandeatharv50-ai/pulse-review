        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              children: [
                _buildKPICard('TOTAL GOALS', '1', Icons.target_outlined, Colors.blue),
                _buildKPICard('IN PROGRESS', '1', Icons.flag_outlined, Colors.orange),
                _buildKPICard('COMPLETED', '0', Icons.check_circle_outline, Colors.green),
                _buildKPICard('OVERDUE', '0', Icons.schedule_outlined, Colors.red),
              ],
            ),
